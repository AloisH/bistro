      ...
      <template #header>
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-sm text-neutral-500 dark:text-neutral-400">Reset link sent</p>
          </div>
        </div>
      </template>

      <div class="space-y-4">
        <UAlert color="info" variant="subtle" title="Password reset email sent">
        ...
        <div class="space-y-2">
          ...
          >
            ...
            <template v-else> Resend reset email </template>
          </UButton>
        </div>
      </div>
