<template>
  <div class="flex min-h-screen items-center justify-center p-4">
    <UCard class="w-full max-w-md">
      ...
      <div v-if="fetchError" class="py-8">
        <UAlert
          color="error"
        ...
        <div class="space-y-4">
          <div>
            ...
            <div class="mt-2 flex items-center gap-3">
              <UIcon name="i-lucide-building-2" class="h-8 w-8 text-neutral-400" />
              <div>
                <h2 class="text-xl font-semibold">
                  {{ invite.organization.name }}
                </h2>
                <p v-if="invite.organization.description" class="text-sm text-neutral-500">
