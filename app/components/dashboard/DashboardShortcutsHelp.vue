    ...
    <template #content>
      <div class="p-6">
        ...
        <div class="space-y-6">
          <!-- Navigation -->
          <div>
            <h3 class="text-muted mb-3 text-sm font-medium uppercase tracking-wider">
              Navigation
            </h3>
            <div class="space-y-2">
              <ShortcutRow
...
const modalShortcuts = computed(() =>
  shortcuts.filter(s => s.category === 'modals'),
);
    ...
    return () =>
      h('div', { class: 'flex items-center justify-between py-1' }, [
        ...
        h('div', { class: 'flex items-center gap-1' }, [
          ...keyParts.value.map(key =>
            h(resolveComponent('UKbd'), { key }, () => key),
          ),
        ]),
      ]);
  },
