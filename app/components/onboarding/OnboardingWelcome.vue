<template>
  <div class="py-8 text-center">
    <div class="mb-6">
      <UIcon name="i-lucide-sparkles" class="text-primary mx-auto h-16 w-16" />
    </div>
    ...
    <div class="mx-auto max-w-sm space-y-3 text-left">
      <div class="flex items-start gap-3">
        <UIcon name="i-lucide-user" class="text-primary mt-0.5 h-5 w-5" />
        <div>
      ...
      <div class="flex items-start gap-3">
        <UIcon name="i-lucide-settings" class="text-primary mt-0.5 h-5 w-5" />
        <div>
      ...
      <div class="flex items-start gap-3">
        <UIcon name="i-lucide-briefcase" class="text-primary mt-0.5 h-5 w-5" />
        <div>
